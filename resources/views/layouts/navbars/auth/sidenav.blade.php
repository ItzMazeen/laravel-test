<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}" target="_blank">
            <img src="{{ asset('./img/ekl.jpeg') }}" class="navbar-brand-img h-80" alt="main_logo">
            <span class="ms-1 font-weight-bold">Eklectic X Partners</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (str_contains(request()->url(), 'user-management') || str_contains(request()->url(), 'users')) ? 'active' : '' }}"
